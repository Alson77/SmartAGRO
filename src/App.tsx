...
import ScrapedSubsidyManagement from './pages/admin/ScrapedSubsidyManagement';
import ExpertBookings from './pages/admin/ExpertBookings';
import CropIssueManagement from './pages/admin/cropIssuemanagement';
import AdminMarketPrices from './pages/admin/MarketPrices';

// Expert Connect Page
import ExpertConnect from './pages/admin/ExpertConnect';
      ...
      <Router>
        <div className="min-h-screen bg-gray-50">
          <Routes>
            ...
            <Route path="/admin/scraped-subsidies" element={
              <AdminProtectedRoute>
                <ScrapedSubsidyManagement />
              </AdminProtectedRoute>
            } />
            <Route path="/admin/expert-bookings" element={
              <AdminProtectedRoute>
                <ExpertBookings />
              </AdminProtectedRoute>
            } />
           ...
           <Route path="/admin/experts" element={
            ...
            <Route path="/expert-connect" element={
              <ProtectedRoute>
                <ExpertConnect />
              </ProtectedRoute>
            } />

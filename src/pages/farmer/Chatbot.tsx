...
const Chatbot: React.FC = () => {
  ...
  const defaultMessage: Message = {
    id: '1',
    text: "Hello! I'm SmartAgro - your smart farming assistant. I can help you with crop advice, disease identification, weather information, and farming best practices. How can I help you today?",
    sender: 'bot',
    timestamp: new Date()
  };
  ...
  const getBotResponse = async (userMessage: string): Promise<string> => {
    ...
    // Mock responses for development/testing when API is unavailable
    const mockResponses: { [key: string]: string } = {
      'disease': 'For crop diseases, I recommend:\n\n1. **Identify the disease** - Look for spots, discoloration, or wilting\n2. **Check weather conditions** - Most fungal diseases thrive in humid conditions\n3. **Apply treatment** - Use appropriate fungicides like copper spray or neem oil\n4. **Prevent spread** - Remove infected leaves and improve air circulation\n\nCould you describe the symptoms your plants are showing?',
      'water': 'Watering tips:\n\n• **Frequency**: Water 2-3 times per week depending on soil moisture\n• **Time**: Water early morning or evening to reduce evaporation\n• **Amount**: Soil should be moist but not waterlogged\n• **Check**: Stick your finger 2 inches in soil - if dry, it\'s time to water\n• **Drainage**: Ensure pots have drainage holes to prevent root rot',
      'fertilizer': 'Fertilizer guidelines:\n\n• **NPK Ratio**: Use 10-10-10 for general crops\n• **Frequency**: Apply every 2-3 weeks during growing season\n• **Type**: Use organic (compost, manure) or chemical fertilizers\n• **Application**: Mix with water and apply at soil level, not on leaves\n• **Timing**: Avoid fertilizing during dormant season',
      'pest': 'Pest management:\n\n1. **Identify** - Check leaf undersides and stems for insects\n2. **Prevention** - Use row covers and crop rotation\n3. **Treatment**:\n   - Neem oil for soft-bodied insects\n   - Insecticidal soap for aphids\n   - Hand-pick larger pests\n4. **Organic approach** - Introduce beneficial insects like ladybugs',
      'season': 'Seasonal farming tips:\n\n**Spring**: Plant warm-season crops, prepare soil\n**Summer**: Water frequently, control pests\n**Fall**: Plant cool-season crops, harvest\n**Winter**: Protect plants, plan next year\'s garden',
    };

    // Check if user message contains keywords for mock responses
    ...
    const defaultMockResponse = 'Hello! I\'m here to help with your farming questions. I can assist with:\n\n• Crop diseases and pest management\n• Watering and irrigation\n• Fertilizer and soil care\n• Seasonal planting guides\n• Weather-based farming tips\n\nWhat farming topic would you like to know more about?';
    
    try {
      // Try to use real API
      const contextualMessage = `[You are SmartAgro, an expert agricultural assistant. ONLY answer farming/agriculture questions. For non-agricultural topics, politely decline and redirect to farming. Provide practical advice in simple language.]
...
User question: ${userMessage}`;
      ...
      if (!res.ok) {
        ...
        console.warn('AI API unavailable, using mock response');
        return defaultMockResponse;
      }
      
      const data = await res.json();
      const botReply = data.choices?.[0]?.message?.content || defaultMockResponse;
      return botReply;
    } catch (err: any) {
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-4 shadow-md">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-white">SmartAgro AI 🤖</h2>

...
const AdminLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-blue-50 to-blue-200 flex items-center justify-center p-6">
      ...
      <button
        onClick={() => navigate('/')}
        className="fixed top-6 left-6 p-2 rounded-lg bg-white/80 hover:bg-white shadow-md hover:shadow-lg transition-all duration-200 group"
        title="Go back (Cmd+[)"
      >

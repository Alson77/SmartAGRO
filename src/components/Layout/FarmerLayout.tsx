...
const RupeeSign = ({ className = '' }) => (
  <span
    ...
    style={{ fontFamily: 'inherit', fontSize: '1.2rem', lineHeight: 1 }}
  >
    रु
  </span>
);
...
const FarmerLayout: React.FC<FarmerLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Expert Connect', href: '/expert-connect', icon: Users },
  ];
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 bg-green-600">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-lg font-semibold text-white">SmartAgro</span>
          </div>
        ...
        <div className="bg-white shadow-sm border-b border-gray-200 lg:hidden">
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-semibold text-gray-900">SmartAgro</span>
            </div>
          </div>
        </div>

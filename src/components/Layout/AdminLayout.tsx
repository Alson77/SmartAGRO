...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Expert Connect', href: '/admin/experts', icon: Shield },
    { name: 'Expert Bookings', href: '/admin/expert-bookings', icon: Shield },
    { name: 'Subsidy Management', href: '/admin/subsidies', icon: NepaliRupeeIcon },
    { name: 'Scraped Subsidies', href: '/admin/scraped-subsidies', icon: TrendingUp },
